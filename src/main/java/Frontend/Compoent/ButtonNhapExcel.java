...
public class ButtonNhapExcel extends JButton{
    public ButtonNhapExcel(String text) {
        super(text);
        ...
        try {
            FlatSVGIcon PdfIcon = new FlatSVGIcon("images/icon/file-spreadsheet.svg", 16, 16);
